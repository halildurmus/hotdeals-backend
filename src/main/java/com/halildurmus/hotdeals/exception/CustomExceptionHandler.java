...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  ResponseEntity<AppError> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException e,
      WebRequest request) {
  ...
  ResponseEntity<AppError> handleValueInstantiationException(ValueInstantiationException e,
      WebRequest request) {
    try {
      final Field requiredField = e.getType().getRawClass().getDeclaredFields()[e.getLocation()
          .getColumnNr()];
