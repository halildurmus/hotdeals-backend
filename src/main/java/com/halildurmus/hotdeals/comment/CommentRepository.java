...
@RepositoryRestResource(collectionResourceRel = "comments", exported = false, path = "comments")
public interface CommentRepository extends MongoRepository<Comment, String> {

  @Override
  @Caching(
      put = {@CachePut(value = "comments", key = "#entity.id")},
      evict = {
  ...
  @Cacheable(
      value = "comments:countCommentsByDealId",
      key = "#dealId.toString()",
      condition = "#dealId != null")
  int countCommentsByDealId(ObjectId dealId);

  @Cacheable(
      value = "comments:countCommentsByPostedById",
      key = "#postedById.toString()",
      condition = "#postedById != null")
