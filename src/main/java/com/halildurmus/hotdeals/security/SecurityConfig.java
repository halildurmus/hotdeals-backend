...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity httpSecurity) throws Exception {
    httpSecurity.cors().configurationSource(corsConfigurationSource()).and().csrf().disable()
        ...
        .antMatchers(HttpMethod.GET, "/comments").access("hasRole('ROLE_SUPER')")
        .antMatchers(HttpMethod.GET, "/comments/search/*").permitAll()
        ...
        .antMatchers(HttpMethod.POST, "/deal-reports").access("hasRole('ROLE_SUPER')")
        ...
        .antMatchers(HttpMethod.POST, "/users").access("hasRole('ROLE_SUPER')")
        ...
        .antMatchers(HttpMethod.POST, "/user-reports").access("hasRole('ROLE_SUPER')")
