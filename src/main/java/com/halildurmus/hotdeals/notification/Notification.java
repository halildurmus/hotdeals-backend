...
public class Notification {
  ...
  @Schema(
      ...
      example =
          "{\"verb\": \"message\", \"object\": \"Ybeuoz0E2oObgUA1Uif8dbXjHX62_ndj2KkbGwIUbfIUH2BT6700AQ832\", \"avatar\": \"https://www.gravatar.com/avatar\", \"message\": \"How are you?\", \"uid\": \"ndj2KkbGwIUbfIUH2BT6700AQ832\"}",
      required = true)
  @NotNull
  private Map<String, String> data;

  @Schema(
      description = "Notification FCM tokens",
      example =
          "dOMvrfckR9-5R_A43nuFMo:APA91bEVh2JQ8i-l1406C68mExotHQCGWeRc0cuLZTDH9t5vXXWIPZ-6HDaOtn1PLipsqWbpNWVcpDxkcIWwHNR60_mtaRo5kyuf0cs5Fxa6iGLpoqV93rpWIisa9_acGbOZwfIass0B",
      required = true)
  @NotEmpty
