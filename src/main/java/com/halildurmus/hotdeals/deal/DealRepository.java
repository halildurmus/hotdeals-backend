...
public interface DealRepository extends MongoRepository<Deal, String> {
  ...
  @Caching(
      evict = {
        @CacheEvict(
            value = "deals:findAllByCategoryStartsWithOrderByCreatedAtDesc",
            allEntries = true),
  ...
  @Override
  @Caching(
      put = {@CachePut(value = "deals", key = "#entity.id")},
      evict = {
  ...
  @Cacheable(
      value = "deals:countDealsByPostedBy",
      key = "#postedBy",
      condition = "#postedBy != null")
  ...
  @Cacheable(
      value = "deals:findAllByCategoryStartsWithOrderByCreatedAtDesc",
      key = "T(java.lang.String).format('%s-%s', #category, #pageable)",
      condition = "#category.blank != true")
  Page<Deal> findAllByCategoryStartsWithOrderByCreatedAtDesc(String category, Pageable pageable);

  @Cacheable(
      value = "deals:findAllByStoreOrderByCreatedAtDesc",
      key = "T(java.lang.String).format('%s-%s', #storeId, #pageable)",
  ...
  @Cacheable(
      value = "deals:findAllByStatusEqualsOrderByCreatedAtDesc",
      key = "T(java.lang.String).format('%s-%s', #status, #pageable)",
      condition = "#status != null")
  Page<Deal> findAllByStatusEqualsOrderByCreatedAtDesc(DealStatus status, Pageable pageable);

  @Cacheable(
      value = "deals:findAllByStatusEqualsOrderByDealScoreDesc",
      key = "T(java.lang.String).format('%s-%s', #status, #pageable)",
      condition = "#status != null")
  Page<Deal> findAllByStatusEqualsOrderByDealScoreDesc(DealStatus status, Pageable pageable);

  @Cacheable(
      value = "deals:findAllByPostedByOrderByCreatedAtDesc",
      key = "T(java.lang.String).format('%s-%s', #postedBy, #pageable)",
      condition = "#postedBy != null")
