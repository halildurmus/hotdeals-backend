...
public class DealController {
  ...
  @Autowired private DealReportService dealReportService;

  @Autowired private DealService service;

  @Autowired private EsDealService esDealService;
    ...
    @ApiResponse(
        ...
        content =
            @Content(
                ...
                array = @ArraySchema(schema = @Schema(implementation = Deal.class)))),
      ...
      for (var price : prices) {
        ...
        if (to != null && (from < 0 || to < 0 || from > to)) {
          throw new ResponseStatusException(
              HttpStatus.BAD_REQUEST, "Invalid PriceRange: " + from + ":" + to);
        }
  ...
  public JsonNode searchDeals(
      @Parameter(description = "Search query", example = "iphone") @RequestParam(value = "query")
          String query,
      ...
      @Parameter(
              description =
                  "Price ranges formatted as <b>&lt;from&gt;:&lt;to&gt;</b><br /><b>&lt;to&gt;</b> value may also receive an <b>asterisk(*)</b> symbol meaning there is <b>no upper limit</b> in the given price range.",
              examples = {
                @ExampleObject(name = "20:50", description = "Lists deals between $20 and $50"),
                @ExampleObject(
                    name = "1500:*",
                    description = "Lists deals with a price of at least $1500")
              })
          @RequestParam(value = "prices", required = false)
          List<String> prices,
      @Parameter(
              description = "Store IDs",
              example = "5fbe790ec6f0b32014074bb2, 5fbe790ec6f0b32014074bb3")
          @RequestParam(value = "stores", required = false)
          List<String> stores,
      @Parameter(description = "Whether to hide expired deals")
          @RequestParam(value = "hideExpired", required = false, defaultValue = "false")
          Boolean hideExpired,
      @Parameter(
  ...
  @ApiResponses({
    @ApiResponse(
        ...
        content =
            @Content(
                mediaType = "application/json",
                schema = @Schema(implementation = DealGetDTO.class))),
  ...
  @ApiResponses({
    @ApiResponse(
        responseCode = "201",
        description = "The deal created successfully",
        content =
            @Content(
                mediaType = "application/json",
                schema = @Schema(implementation = DealGetDTO.class))),
  ...
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        description = "The deal successfully updated",
        content =
            @Content(
                mediaType = "application/json",
                schema = @Schema(implementation = DealGetDTO.class))),
    ...
    @ApiResponse(
        responseCode = "403",
        description = "You can only update your own deal",
        content = @Content),
    @ApiResponse(responseCode = "404", description = "Deal not found", content = @Content)
  })
  ...
  @ApiResponses({
    @ApiResponse(
        responseCode = "204",
        description = "The deal successfully deleted",
        content = @Content),
    @ApiResponse(responseCode = "400", description = "Invalid deal ID", content = @Content),
    @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content),
    @ApiResponse(
        responseCode = "403",
        description = "You can only remove your own deal",
        content = @Content),
    @ApiResponse(responseCode = "404", description = "Deal not found", content = @Content)
  })
  ...
  @ResponseStatus(HttpStatus.CREATED)
  @Operation(
      summary = "Adds a comment to a deal",
      security = @SecurityRequirement(name = "bearerAuth"))
  @ApiResponses({
    @ApiResponse(
        responseCode = "201",
  ...
  @ResponseStatus(HttpStatus.CREATED)
  @Operation(
      summary = "Reports a deal comment",
      security = @SecurityRequirement(name = "bearerAuth"))
  @ApiResponses({
    @ApiResponse(responseCode = "201", description = "Successful operation", content = @Content),
    @ApiResponse(
        responseCode = "400",
        description = "Invalid deal or comment ID",
        content = @Content),
    @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content),
    @ApiResponse(
        responseCode = "404",
        description = "Deal or comment not found",
        content = @Content)
  })
  public void createCommentReport(
      @Parameter(
          ...
          String id,
      @Parameter(
              description = "String representation of the Comment ID",
              example = "5fbe790ec6f0b32014074bb2")
          @IsObjectId
          @PathVariable
          String commentId,
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        responseCode = "304",
        description = "You've already upvoted/downvoted this deal before",
        content = @Content),
    @ApiResponse(responseCode = "400", description = "Invalid deal ID", content = @Content),
    @ApiResponse(responseCode = "401", description = "Unauthorized", content = @Content),
    @ApiResponse(responseCode = "404", description = "Deal not found", content = @Content)
  ...
  @Operation(
      summary = "Deletes the vote from a deal",
      security = @SecurityRequirement(name = "bearerAuth"))
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
